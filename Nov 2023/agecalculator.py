...
#  then the program will print their age. Write the same program to find your age and help your classmates in finding their age

def age_calculation(birthyear_input,presentyear_input):
    if birthyear_input < 1924:
        print("Invalid Birthyear:::")
    elif birthyear_input >= 1924:
        result = presentyear_input-birthyear_input
        print(result," Year Old")
